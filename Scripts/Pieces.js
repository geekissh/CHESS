...
class King {
    ...
    getMoves(B) {
        ...
        if (this.j < 8 && this.i > 1 && (B.Squares[this.i - 1][this.j + 1].piece == undefined || (B.Squares[this.i - 1][this.j + 1].piece != undefined && B.Squares[this.i - 1][this.j + 1].piece.color != this.color))) {
              coordinates.push(new Coordinate(this.i - 1, this.j + 1))
        }
        ...
        if(!this.moved){
            ...
            if(B.Squares[this.i][1].piece != undefined && !B.Squares[this.i][1].piece.moved){ //left
                ...
                for(let k = this.j; k >1; k--){ //checking if a check comes in between or any piece is in the way
                    ...
                    else if (B.Squares[this.i][k].potentialBlackCheck) {noChecksInBetween = false;}
                }
